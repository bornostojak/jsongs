...
Welcome to ``JSONgs`` contributor's guide.
...
If you experience bugs or general issues with ``JSONgs``, please have a look
...
You can help improve ``JSONgs`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``JSONgs`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``JSONgs``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/JSONgs.git
    cd JSONgs
...
#. Install |pre-commit|_::
   ...
   ``JSONgs`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/JSONgs
.. _issue tracker: https://github.com/<USERNAME>/JSONgs/issues
.. <-- end -->
